...
import { Camera, Sparkles, Download, Loader2, AlertCircle, CheckCircle2 } from 'lucide-react';
...
export function UploadSection({ credits, totalCredits, onUseCredit, onRestoreComplete }: UploadSectionProps) {
      ...
      <div className="max-w-4xl mx-auto px-6 text-center">
        <div className="mb-12">
          <span className="bg-emerald-500/10 text-emerald-500 border border-emerald-500/20 px-4 py-1.5 rounded-full text-sm font-bold inline-flex items-center gap-2 mb-6">
            <Sparkles size={14} />
            {totalCredits > 0 ? `${totalCredits} Créditos Disponíveis` : 'Sem Créditos'}
          </span>
